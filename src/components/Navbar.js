...
import { removeFromCart } from '../redux/cartSystem'
  ...
  return (
    ...
    <div className='Nav-bar'>
      <div className="logo">
      <NavLink to="/" onClick={handelPage}><img src="../imges/logo.svg" alt="logo" /></NavLink>
      <div className="ul">
      <ul>
        <li><NavLink to="collections">Collections</NavLink> </li>
        <li>Men </li>
      ...
      <i class="fa-solid fa-cart-shopping" onClick={handleClick_mobile}><div className="countCart-mobile">{Object.keys(products).length}</div></i>
          ...
          <div className="con">
            {
              ...
              array[0].map(e=>
                ...
                <i class="fa-solid fa-trash-can delete" onClick={()=>dispatch(removeFromCart(e))}></i>
                </div>
