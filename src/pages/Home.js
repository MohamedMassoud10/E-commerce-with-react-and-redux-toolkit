      ...
      <div>
        <motion.div className="carousel" ref={carouselRef}>
          ...
          >
            ...
            <motion.div className="item">
              <img
                src="https://preview.colorlib.com/theme/aroma/img/home/hero-slide2.png.webp"
                alt="slider-images"
              />
              <div className="caption">
                <div className="catoName">
            ...
            <motion.div className="item">
              <img
                src="https://preview.colorlib.com/theme/aroma/img/home/hero-slide3.png.webp"
                alt="slider-images"
              />
              <div className="caption">
                <div className="catoName">
      ...
      <footer>
        <div className="footer-title">
          <p>
            ...
            <i class="fa-solid fa-heart"></i> by Mohamed Massoud
          </p>
        </div>
      </footer>
    </>
